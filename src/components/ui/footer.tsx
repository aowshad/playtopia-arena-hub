    ...
    <footer className="bg-gray-50 border-t border-gray-200 py-8">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {/* Column 1: About */}
          <div>
            <h3 className="font-semibold text-gray-800 mb-3">Matthperiye</h3>
            <p className="text-sm text-gray-600 mb-4">
              Book sports venues, join tournaments, and manage your teams in one platform.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <Link to="/fields" className="text-gray-600 hover:text-gray-900">Book a Field</Link>
              </li>
              <li>
                <Link to="/teams" className="text-gray-600 hover:text-gray-900">Team Management</Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li className="flex items-start">
                ...
                <span className="text-gray-600">123 Sports Street, Dhaka, Bangladesh</span>
              </li>
              <li className="flex items-start">
                <svg className="h-5 w-5 mr-2 text-gray-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                <span className="text-gray-600">info@matthperiye.com</span>
              </li>
              <li className="flex items-start">
                <svg className="h-5 w-5 mr-2 text-gray-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div className="mt-8 pt-6 border-t border-gray-200 text-center text-sm text-gray-600">
          <p>© {new Date().getFullYear()} Matthperiye. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
